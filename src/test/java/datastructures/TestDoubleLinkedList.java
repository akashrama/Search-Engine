...
public class TestDoubleLinkedList extends BaseTest {
    ...
    @Test(timeout=SECOND)
    public void testDeleteGetOutOfBoundsThrowsException() {
        IList<String> list = this.makeBasicList();
        try {
            list.delete(-1);
            fail("Expected IndexOutOfBoundsException");
    ...
    @Test(timeout=15 * SECOND)
    public void testAddAndDeleteAndIteratorIsEfficient() {
        IList<Integer> list = new DoubleLinkedList<>();
        int cap = 100000;
        for (int i = 0; i < cap; i++) {
            list.add(i * 2);
    ...
    public void testDelete() {
        ...
        assertListMatches(new String[] {"b", "c", "d", "e"}, list);
        list.delete(2);
        assertEquals(list.get(1), "c");
        assertListMatches(new String[] {"b", "c", "e"}, list);
        list.delete(2);
        assertEquals(list.get(1), "c");
        ...
        list.delete(1);
        list.delete(2);
        assertListMatches(new String[] {"b", "z"}, list);
        list.delete(1);
        list.delete(0);
        assertListMatches(new String[] {}, list);
    ...
    public void testDeleteReturnValue() {
        IList<String> list = this.makeBasicList();
        String a = list.delete(1);
        assertEquals(a, "b");
        assertListMatches(new String[] {"a", "c"}, list);
        String b = list.delete(1);
        assertEquals(b, "c");
